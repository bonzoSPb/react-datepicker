        ...
        return (
          ...
          ue(we(e), "liClasses", function(t, r, n) {
            ...
            return (
              ...
              e.props.injectTimes &&
                (60 * k(t) + g(t)) % e.props.intervals != 0 &&
              ...
              if (!Ae(s.props.selected, a) || s.props.allowSameDay) {
                if (null !== a) {
                  if (s.props.selected) {
                    ...
                    r && (o = Se(a)),
                      (a = Ne(a, { hour: k(o), minute: g(o), second: w(o) }));
                  }
            ...
            if (s.state.open || s.props.inline || s.props.preventOpenOnFocus) {
              if (s.state.open) {
                if ("Tab" === t)
                  return (
                    e.preventDefault(),
                    void (s.inputOk() && s.state.lastPreSelectChange === It
                      ? (s.handleSelect(n, e),
